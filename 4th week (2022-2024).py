# -*- coding: utf-8 -*-
"""
Created on Mon Oct 28 02:59:29 2024
...
def process_first_week_data(df):
    ...
    df = df[(df['pick_up_date'].dt.day >= 22) & (df['pick_up_date'].dt.day <= 31)]
...
# Process the data
fourth_week_volume = process_first_week_data(data)
...
sns.barplot(data=fourth_week_volume, x='month', y='number_of_pallets_per_day', hue='trucking')
plt.title('Volume of Deliveries by Truck Type (Last Week of Each Month from 2022 to 2024)')
plt.xlabel('Month')
