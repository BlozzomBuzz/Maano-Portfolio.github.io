# -*- coding: utf-8 -*-
"""
Created on Mon Oct 28 02:53:36 2024
...
# Process the data
first_week_volume = process_first_week_data(data)

# Check the processed data before plotting
print("Delivery Volume Data:")
print(first_week_volume)

# Plotting
plt.figure(figsize=(12, 6))
sns.barplot(data=first_week_volume, x='month', y='number_of_pallets_per_day', hue='trucking')
plt.title('Volume of Deliveries by Truck Type (First Week of Each Month from 2022 to 2024)')
plt.xlabel('Month')
