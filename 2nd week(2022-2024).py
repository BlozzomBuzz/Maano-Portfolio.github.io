# -*- coding: utf-8 -*-
"""
Created on Mon Oct 28 02:58:19 2024
...
def process_first_week_data(df):
    ...
    df = df[(df['pick_up_date'].dt.day >= 8) & (df['pick_up_date'].dt.day <= 15)]
...
# Process the data
second_week_volume = process_first_week_data(data)

# Check the processed data before plotting
print("Delivery Volume Data:")
print(second_week_volume)

# Plotting
plt.figure(figsize=(12, 6))
sns.barplot(data=second_week_volume, x='month', y='number_of_pallets_per_day', hue='trucking')
plt.title('Volume of Deliveries by Truck Type (Second Week of Each Month from 2022 to 2024)')
plt.xlabel('Month')
